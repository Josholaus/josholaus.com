...
export default function MainPage() {
    return (
        <div className="w-full md:px-12">
            ...
            <img className="w-44 h-44 rounded-xl mx-auto shadow-xl" src="/images/image.png" alt="Josholaus in action" />
            ...
            <Link to="/projects">
                <p className="text-md mt-3 hover:-translate-y-1 transform duration-150">
